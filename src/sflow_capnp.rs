...
pub mod s_flow_flow_record {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 349] = [
            ...
            ::capnp::word(141, 0, 0, 0, 129, 3, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,2,3,4,10,16,18,11,13,12,14,9,6,8,7,15,17,19,0,20,5];
        pub(crate) const TYPE_ID: u64 = 0xcf27_d890_97eb_551a;
    }
}
